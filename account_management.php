...
if (!$conn) {
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            $reject_button = '<form method="POST" style="margin: 0px;">
                            ...
                            ';
            $pending_button = '<form method="POST" style="margin: 0px;">
                            <input type="hidden" name="userid_hold" value="' . $row["userid"] . '">
    ...
    if (isset($_POST['userid_approve']) || isset($_POST['userid_reject']) || isset($_POST['userid_hold'])) { //if button is clicked
        ...
        if (isset($_POST['userid_hold'])) {
            $userid = $_POST['userid_hold'];
            $status = "pending";
        }
